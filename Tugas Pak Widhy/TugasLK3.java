...
public class TugasLK3 {
    public static void main(String[] args) {
        ...
        Bus bus2 = new Bus("H 4444 XX", "Mercedes", 10, supirBus);

        // obj penumpang
        Penumpang penumpang1 = new Penumpang("Pak S", 40);
        Penumpang penumpang2 = new Penumpang("Pak D", 41);
        Penumpang penumpang3 = new Penumpang("Pak G", 42);
        Penumpang penumpang4 = new Penumpang("Pak H", 43);
        ...
        angkot1.tambahPenumpang(penumpang3);
        angkot1.tambahPenumpang(penumpang4);
        ...
        for (Penumpang penumpang : bus1.getDaftarPenumpang()) {
            if(penumpang != null) System.out.println("- " +penumpang.getNama());
        }

        System.out.println("Penumpang di dalam angkot : ");
        for (Penumpang penumpang : angkot1.getDaftarPenumpang()) {
            if(penumpang != null) System.out.println("- " +penumpang.getNama());
        }
    } 
}
